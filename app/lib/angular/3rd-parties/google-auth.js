...
angular.module('jackrabbitsgroup.angular-google-auth', [])
    .provider('jrgGoogleAuth', function jrgGoogleAuthProvider() {
        ...
        function configure( params ) {
            ...
            if (params.scopeHelp && params.scopeHelp.length) {
        ...
        this.$get = [ '$rootScope', '$http', '$q', function ( $rootScope, $http, $q ) {
             ...
             * @param {Object} authResult The response object as returned from google API
             */
                            ...
                            .success(function (data) {
                                ...
                                if (params.extraInfo.emails) {
                                    ...
                                    if (data.emails !== undefined) {
                                        ...
                                        var promise = service.getContacts({'emailOnly': true});
            ...
            /**
             * Gets the (currently connected) user's profile
